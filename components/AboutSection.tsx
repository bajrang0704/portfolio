      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16 items-center">
          ...
          >
            <div className="mb-6">
              <h2
                className="text-4xl lg:text-5xl font-black text-[#F0F6FF] mb-2"
                style={{ fontFamily: "var(--font-syne)" }}
              >
                Who I Am
              </h2>
              <div className="h-1 w-16 rounded-full" style={{ background: "linear-gradient(135deg, #00D9FF, #7B2FFF)" }} />
            </div>

            <div
              className="space-y-5 text-[#7A8A99] text-base lg:text-lg leading-relaxed"
            ...
            >
              ...
              <p>
                At <span className="text-[#00D9FF] font-medium">Sync AI Technologies</span>, I architect and ship end-to-end AI systems: RAG
              ...
              <p>
                ...
                <span className="text-[#7B2FFF] font-medium">Agentic AI Trainer at Capably</span>,
          ...
          <div className="lg:col-span-2 grid grid-cols-2 gap-4">
            {stats.map((stat, i) => (
              <motion.div
                ...
                viewport={{ once: true }}
                className="glass-card gradient-top-border gradient-top-border-gradient relative rounded-xl p-6 flex flex-col gap-2 hover:border-white/15 transition-all"
              >
                <span
                ...
                <span
                  className="text-[#7A8A99] text-xs leading-snug"
                  style={{ fontFamily: "var(--font-dm-sans)" }}
                >
                  {stat.label}
                </span>
